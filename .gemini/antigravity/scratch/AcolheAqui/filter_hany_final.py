...
try:
    with open(input_file, 'r', encoding=encoding) as f_in, \
        ...
        date_col = "Requested Time" # Based on inspection
        ...
        # Fallback for owner (reuse logic)
    ...
    print(f"Successfully saved {count} appointments for 'Hany Campos' in December 2025 to '{output_file}'")
