...
if ($usuario_id_logado === 0 || ($_SESSION['tipo'] ?? '') !== 'infoprodutor') {
    $_SESSION['flash_message'] = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Acesso negado. Você precisa ser um infoprodutor para gerenciar ofertas.</div>";
...
if (!isset($source_product_id) || !is_numeric($source_product_id)) {
    $_SESSION['flash_message'] = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>ID do produto de origem inválido.</div>";
...
if (!$source_product) {
    $_SESSION['flash_message'] = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Produto de origem não encontrado ou você não tem permissão para acessá-lo.</div>";
    header("Location: index.php?pagina=area_membros");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['salvar_ofertas'])) {
    ...
    try {
        ...
        header("Location: index.php?pagina=infoprodutor_member_offers&source_product_id={$source_product_id}");
        exit;
...
<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Gerenciar Ofertas para "<span class="text-orange-600"><?php echo $source_product_name; ?></span>"</h1>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md">
        <p class="text-gray-600 mb-6">
            ...
            para clientes que JÁ POSSUEM o curso "<span class="font-semibold text-gray-800"><?php echo $source_product_name; ?></span>".
        ...
        <?php else: ?>
            <form action="index.php?pagina=infoprodutor_member_offers&source_product_id=<?php echo $source_product_id; ?>" method="post">
                        ...
                        <div class="group bg-gray-50 rounded-lg overflow-hidden border hover:shadow-lg transition-shadow duration-300 flex flex-col">
                            ...
                            <div class="p-4 flex-grow flex flex-col justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Produto de Área de Membros</p>
                                </div>
                ...
                <div class="mt-8 border-t pt-6">
                    <button type="submit" name="salvar_ofertas" class="bg-orange-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2">
