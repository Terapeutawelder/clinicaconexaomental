...
<body class="min-h-screen text-slate-800 pb-20">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <!-- Card Webhooks -->
            <a href="index.php?pagina=integracoes_webhooks" class="card-hover group relative bg-white border border-slate-200 rounded-2xl p-8 flex flex-col justify-between h-full hover:border-orange-300 overflow-hidden cursor-pointer">
                <!-- Background Decoration -->
                <div class="absolute top-0 right-0 -mt-8 -mr-8 w-32 h-32 bg-orange-50 rounded-full opacity-50 group-hover:scale-150 transition-transform duration-500"></div>

                <div class="relative z-10">
                    <div class="flex items-center gap-5 mb-6">
                        <div class="h-16 w-16 rounded-2xl bg-orange-50 flex items-center justify-center border border-orange-100 shadow-sm group-hover:bg-orange-100 transition-colors">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-slate-900 group-hover:text-orange-600 transition-colors">Webhooks</h2>
                ...
                <div class="relative z-10 mt-auto pt-6 border-t border-slate-100">
                    <span class="flex items-center text-sm font-bold text-orange-600 group-hover:text-orange-700 transition-colors">
