...
<body class="bg-gray-900 text-gray-200 antialiased">
            ...
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center space-x-4">
                    <a href="member_area_dashboard.php">
                        <img src="https://i.ibb.co/0RGhGvMt/Gemini-Generated-Image-hdcuf5hdcuf5hdcu-Photoroom.png" alt="Starfy Logo" class="h-10">
                    </a>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class_id="intro-header" class="mb-10">
            <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-500 mb-2">
                            ...
                            slide.innerHTML = `
                                <a href="${checkoutLink}" class="offer-card-style offer-card relative block">
                                    ...
                                    <div class="p-5 flex-grow flex flex-col justify-between">
                                        ...
                                        <span class="inline-block bg-orange-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase mb-3 self-start">
                                            Oferta Exclusiva
                                        </span>
