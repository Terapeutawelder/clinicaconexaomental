...
<div class="container mx-auto relative">
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
        <div data-status="all" class="metric-card p-4 bg-white rounded-lg shadow-md cursor-pointer border-2 border-orange-500">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="mb-4">
            <div class="relative">
                ...
                <input type="text" id="search-input" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-orange-500 focus:border-orange-500 sm:text-sm" placeholder="Pesquisar por nome, e-mail ou ID...">
            </div>
        </div>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="email" id="modal-email-input" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border p-2" placeholder="email@cliente.com">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" id="confirm-resend-btn" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-orange-600 text-base font-medium text-white hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Enviar Agora
                </button>
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            if (data.vendas.length === 0) {
                ...
                data.vendas.forEach(venda => {
                    ...
                    if (venda.status_pagamento === 'approved' || venda.status_pagamento === 'paid' || venda.status_pagamento === 'completed') {
                        actionsHtml += `
                            <button class="resend-btn text-orange-600 hover:text-orange-800 p-1" title="Reenviar Acesso" onclick="openResendModal(${venda.id}, '${venda.comprador_email}')">
                    ...
                    tr.innerHTML = `
                        ...
                        <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm text-gray-700">${venda.produto_nome || 'Produto não encontrado'}</div></td>
    ...
    metricCardsContainer.addEventListener('click', (e) => {
        ...
        if (card) {
            document.querySelectorAll('.metric-card').forEach(c => { c.classList.remove('border-orange-500'); c.classList.add('border-transparent', 'hover:border-gray-300'); });
            card.classList.add('border-orange-500'); card.classList.remove('border-transparent', 'hover:border-gray-300');
