    ...
    <div class="bg-white p-8 rounded-lg shadow-md">
        ...
        <?php if (empty($cursos)): ?>
            <div class="text-center py-12 text-gray-500">
                ...
                <p>Vá para a <a href="index.php?pagina=produtos" class="text-orange-600 hover:underline font-semibold">página de produtos</a> para configurar um.</p>
            </div>
        <?php else: ?>
                    ...
                    <div class="group bg-gray-50 rounded-lg overflow-hidden border hover:shadow-xl transition-shadow duration-300 flex flex-col">
                        ...
                        <div class="p-4 flex-grow flex flex-col justify-between">
                            ...
                            <div class="mt-2 flex flex-col gap-2"> <!-- Alterado para flex-col e gap-2 para empilhar botões -->
                                <a href="curso_preview.php?produto_id=<?php echo $curso['id']; ?>" target="_blank" class="flex-1 text-center bg-gray-600 text-white font-bold py-2 px-3 rounded-lg hover:bg-gray-700 transition duration-300 flex items-center justify-center space-x-2 text-sm">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                    <span>Pré-visualizar</span>
                                </a>
                                <a href="index.php?pagina=gerenciar_curso&produto_id=<?php echo $curso['id']; ?>" class="flex-1 text-center bg-orange-600 text-white font-bold py-2 px-3 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 text-sm">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                    <span>Gerenciar</span>
                                </a>
                                <!-- NOVO BOTÃO 'OFERTAS' -->
                                <a href="index.php?pagina=infoprodutor_member_offers&source_product_id=<?php echo $curso['id']; ?>" class="flex-1 text-center bg-purple-600 text-white font-bold py-2 px-3 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center justify-center space-x-2 text-sm">
