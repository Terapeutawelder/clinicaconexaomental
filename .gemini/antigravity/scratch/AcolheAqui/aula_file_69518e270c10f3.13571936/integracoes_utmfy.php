...
try {
    ...
    $mensagem = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Erro ao buscar produtos para UTMfy: " . htmlspecialchars($e->getMessage()) . "</div>";
...
<div class="container mx-auto">
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-gray-600">Conecte a Starfy à UTMfy para enviar notificações de vendas e rastrear links.</p>
        </div>
    </div>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md mb-8">
        ...
        <form id="utmfy-form" class="space-y-6">
            ...
            <div>
                <label for="product_id" class="block text-gray-700 text-sm font-semibold mb-2">Produto Associado (Opcional)</label>
                ...
                <p class="text-xs text-gray-500 mt-1">Selecione um produto para que a UTMfy seja notificada apenas para vendas dele. Deixe vazio para notificar para todos os produtos.</p>
            </div>
            ...
            if (result.success) {
                ...
                if (cachedIntegrations.length === 0) {
                    ...
                    cachedIntegrations.forEach(integration => {
                        ...
                        const productName = integration.product_name ? htmlspecialchars(integration.product_name) : '<span class="text-gray-500">(Todos os produtos)</span>';
                        ...
                        integrationItem.innerHTML = `
                            <div class="flex-1 mb-2 sm:mb-0">
                                ...
                                <p class="text-sm text-gray-600">Produto: ${productName}</p>
