...
<head>
    ...
    <title>Acesso à Área de Membros - Starfy</title>
    ...
    <style> 
        ...
        .modern-input:focus {
            ...
            border-color: #f97316; /* Laranja Starfy */
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[450px] bg-white p-8 md:p-12 rounded-3xl shadow-2xl shadow-slate-200/50 border border-slate-100">
        ...
        <div class="text-center mb-10">
            <div class="inline-flex justify-center p-4 rounded-3xl bg-orange-50 mb-6">
                 <img src="https://i.ibb.co/jZqbR2dv/1757909548831-Photoroom.png" alt="Logotipo da Starfy" class="w-auto h-12 object-contain">
            </div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="space-y-6">
            ...
            <button type="submit" class="btn-primary w-full text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/40 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 group mt-4">
        ...
        <p class="text-center text-xs text-slate-400 mt-10">
            &copy; <?php echo date("Y"); ?> Starfy. Todos os direitos reservados.
        </p>
    </div>
