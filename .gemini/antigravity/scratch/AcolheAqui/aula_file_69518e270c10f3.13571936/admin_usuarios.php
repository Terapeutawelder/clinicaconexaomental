...
$active_class_filter_btn = 'bg-orange-600 text-white shadow';
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mb-6 space-y-4 sm:space-y-0 sm:space-x-4">
                <div class="relative w-full sm:w-1/2">
                    ...
                    <input type="text" id="search-input" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-orange-500 focus:border-orange-500 sm:text-sm" placeholder="Pesquisar por nome ou e-mail...">
                </div>
                <button id="add-user-btn" class="w-full sm:w-auto bg-orange-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2">
        ...
        <div class="modal-content">
            ...
            <form id="user-form" action="" method="post" class="p-6 space-y-5">
                ...
                <div class="flex justify-end items-center space-x-4">
                    ...
                    <button type="submit" class="bg-orange-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-orange-700 transition">Salvar Usuário</button>
                </div>
            </form>
        </div>
    </div>
                ...
                try {
                    ...
                    if (data.users.length === 0) {
                        ...
                        data.users.forEach(user => {
                            ...
                            if (user.tipo === 'admin') {
                                userTypeClass = 'bg-orange-100 text-orange-800'; // Admin
                                userTypeText = 'Admin';
                            } else if (user.tipo === 'infoprodutor') {
                                userTypeClass = 'bg-green-100 text-green-800'; // Infoprodutor
                            ...
                            tr.innerHTML = `
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button data-id="${user.id}" class="edit-btn text-orange-600 hover:text-orange-900 mr-2">
