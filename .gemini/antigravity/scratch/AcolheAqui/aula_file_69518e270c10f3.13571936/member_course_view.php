...
<head>
    ...
    <style>
        ...
        .module-card.active { border-color: #f97316; box-shadow: 0 0 15px rgba(249, 115, 22, 0.5); }
                        ...
                        <div class="swiper mySwiper modules-swiper pb-10">
                            <div class="swiper-wrapper">
                                <?php foreach ($modulos_com_aulas as $index => $item): ?>
                                                                    ...
                                                                    $module_button_classes = "module-card w-full block group relative rounded-lg overflow-hidden border-2 border-gray-700 hover:border-orange-500 focus:outline-none focus:ring-4 focus:ring-orange-500/50 transition-all duration-300 text-left";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOverallProgress() {
                ...
                document.querySelector('#player-wrapper .bg-orange-500').style.width = `${newProgressPercent}%`;
            }
