        ...
        <form action="index.php?pagina=profile" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nome" name="nome"
                       class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-200"
            ...
            <div class="mt-8 pt-6 border-t">
                <button type="submit" name="salvar_perfil" class="bg-orange-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-700 transition duration-300">
                    Salvar Alterações
                </button>
            </div>
        </form>
