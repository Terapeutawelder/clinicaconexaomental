...
<body class="bg-slate-50 min-h-screen">
        ...
        <div class="hidden lg:flex relative flex-col justify-end p-12 overflow-hidden bg-slate-900 order-2 lg:order-1">
            ...
            <div class="relative z-20 mb-8 max-w-lg">
                <div class="inline-block px-3 py-1 mb-4 rounded-full bg-orange-500/20 border border-orange-500/30 backdrop-blur-md">
                    <span class="text-orange-400 text-xs font-bold tracking-wider uppercase">Junte-se à Elite</span>
                </div>
                <h1 class="text-5xl font-bold text-white mb-4 leading-tight">
                    Comece a vender <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-200">em minutos.</span>
                </h1>
        ...
        <div class="flex items-center justify-center p-8 bg-white order-1 lg:order-2">
            <div class="w-full max-w-[480px] space-y-6">
                ...
                <div class="text-center">
                    <div class="inline-flex justify-center mb-6 p-4 rounded-3xl bg-orange-50 mb-4">
                        <img src="https://i.ibb.co/jZqbR2dv/1757909548831-Photoroom.png" alt="Logo" class="w-auto h-12 object-contain">
                    </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="space-y-4">
                    ...
                    <button type="submit" class="btn-primary w-full text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/40 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 group mt-6">
                ...
                <div class="pt-6 border-t border-slate-100 text-center">
                    <p class="text-slate-500 text-sm">
                        Já tem uma conta? 
                        <a href="login.php" class="text-orange-600 font-semibold hover:text-orange-700 transition-colors">Fazer Login</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const actions = [
            { type: 'Nova Conta', icon: 'user-plus', color: 'text-orange-500', valueRange: [0, 0] }, // Exclusivo para página de registro
