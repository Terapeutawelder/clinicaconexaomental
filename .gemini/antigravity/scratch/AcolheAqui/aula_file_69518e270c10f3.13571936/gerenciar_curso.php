...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($should_redirect) {
            ...
            header("Location: index.php?pagina=gerenciar_curso&produto_id=" . $produto_id);
            exit;
        }
    }
...
<div class="container mx-auto">
    <div class="flex items-center mb-6">
        <a href="index.php?pagina=area_membros" class="text-orange-600 hover:text-orange-800 mr-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" enctype="multipart/form-data">
            <div class="mb-4">
                ...
                <?php endif; ?>
                <input type="file" id="banner_curso" name="banner_curso" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100" accept="image/*">
                <p class="mt-1 text-xs text-gray-500">Recomendado: 1920x400px</p>
            </div>
            <button type="submit" name="salvar_banner_curso" class="bg-orange-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-orange-700 transition">Salvar Banner</button>
        </form>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" class="space-y-4"> <!-- Changed to space-y-4 for vertical stacking -->
            <div>
            ...
            <div class="flex justify-end">
                <button type="submit" name="adicionar_modulo" class="bg-orange-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center space-x-2">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="bg-gray-50 p-4 flex justify-between items-center border-b">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-800">
                                ...
                                <?php if ($item['modulo']['release_days'] > 0): ?>
                                    <span class="ml-2 text-sm font-medium text-orange-600">(Liberado em <?php echo $item['modulo']['release_days']; ?> dias)</span>
                                <?php endif; ?>
                            </h3>
                        </div>
                        <div class="flex items-center space-x-2">
                            ...
                            <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" onsubmit="return confirm('Tem certeza que deseja deletar este módulo e todas as suas aulas?');">
                                ...
                                <?php foreach ($item['aulas'] as $aula): ?>
                                    <li class="flex justify-between items-center p-3 bg-gray-50 rounded-md border hover:bg-gray-100 aula-item" data-aula-id="<?php echo $aula['id']; ?>">
                                        <div class="flex items-center space-x-3 cursor-grab">
                                            ...
                                            <span class="font-medium text-gray-700">
                                                ...
                                                <?php if ($aula['release_days'] > 0): ?>
                                                    <span class="ml-2 text-sm font-medium text-orange-500">(Liberada em <?php echo $aula['release_days']; ?> dias)</span>
                                                <?php endif; ?>
                                            </span>
                                        </div>
                                        <div class="flex items-center space-x-2 flex-shrink-0">
                                            ...
                                            <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" onsubmit="return confirm('Tem certeza que deseja deletar esta aula?');" class="inline-block">
...
<div id="add-lesson-modal" class="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 hidden">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl transform transition-all opacity-0 scale-95" id="add-lesson-modal-content">
        <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" enctype="multipart/form-data">
            <div class="p-6 border-b"><h2 class="text-2xl font-bold text-gray-800">Adicionar Nova Aula em <span id="modal-modulo-titulo-add" class="text-orange-600"></span></h2></div>
            <div class="p-6 space-y-4">
                ...
                <div id="add-files-upload-container">
                    ...
                    <input type="file" id="add_aula_files" name="aula_files[]" multiple class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100">
        ...
        <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-4">
                ...
                <div id="edit-new-files-upload-container">
                    ...
                    <input type="file" id="edit_aula_files" name="aula_files[]" multiple class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100">
                    <p class="mt-1 text-xs text-gray-500">Múltiplos arquivos (PDF, imagens, zip, etc.)</p>
                </div>
        ...
        <form action="index.php?pagina=gerenciar_curso&produto_id=<?php echo $produto_id; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="file" id="imagem_capa_modulo" name="imagem_capa_modulo" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100" accept="image/*">
                    <label class="mt-2 flex items-center text-sm text-gray-600">
