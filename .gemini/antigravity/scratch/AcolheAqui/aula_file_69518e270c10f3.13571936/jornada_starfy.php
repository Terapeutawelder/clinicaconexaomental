...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const STARFY_STAGES = [
        ...
        { name: 'SUPERNOVA DOURADA', min: 500000, max: 1000000, description: 'Um evento cósmico de proporções grandiosas! Sua energia explode, iluminando vastas extensões. Você é uma força que redefine o seu entorno, uma referência inconfundível.', color_classes: 'from-yellow-400 via-amber-600 to-orange-700' },
        { name: 'GALÁXIA SUPREMA', min: 1000000, max: 5000000, description: 'Você se tornou um universo em si, com trilhões de estrelas e uma complexidade que inspira. Uma galáxia construída com visão, resiliência e paixão, reconhecida por sua vastidão.', color_classes: 'from-orange-400 via-red-600 to-rose-700' },
    ...
    function renderAllStagesTimeline(currentFaturamento) {
        ...
        STARFY_STAGES.forEach((stage, index) => {
            ...
            if (currentFaturamento >= stage.min && currentFaturamento < stage.max) {
                ...
                status = 'current';
                iconName = 'star';
                iconClasses = 'text-orange-500 animate-pulse';
                dotClasses = 'bg-orange-100 border-orange-500';
                cardClasses = 'bg-white border-orange-500 shadow-md shadow-orange-100';
