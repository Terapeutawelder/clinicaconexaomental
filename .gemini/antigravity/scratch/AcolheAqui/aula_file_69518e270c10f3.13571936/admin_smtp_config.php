...
<div class="bg-white rounded-lg shadow-md p-6"> <!-- Alterado p-8 para p-6 e removido container mx-auto -->
    ...
    <form id="email-settings-form">
        ...
        <h2 class="text-2xl font-semibold mb-6 text-gray-800 border-t pt-6">E-mail de Entrega do Produto</h2>
        <p class="text-sm text-gray-500 mb-4">Personalize o e-mail que seus clientes recebem após a compra com os acessos aos produtos.</p>
        ...
        <div class="mb-6">
            ...
            <div class="border border-gray-300 rounded-lg overflow-hidden">
                ...
                <textarea id="email_template_delivery_html" name="email_template_delivery_html" rows="15" 
                          class="w-full p-4 bg-gray-900 text-green-300 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-orange-500 hidden"
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-1">Esta URL será incluída nos e-mails de acesso para produtos da área de membros.</p>
        </div>
        ...
        <div class="mt-8 pt-6 border-t flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <button type="submit" id="save-settings-btn" class="bg-orange-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2">
