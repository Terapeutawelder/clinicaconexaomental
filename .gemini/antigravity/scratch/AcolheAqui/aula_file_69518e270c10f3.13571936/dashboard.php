<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            <div class="absolute inset-0 rounded-lg bg-gradient-to-l from-amber-400 to-orange-500 opacity-0 group-hover:opacity-30 pointer-events-none z-0 bg-[size:200%_100%] bg-[position:0%_0%] group-hover:bg-[position:100%_0%] transition-all duration-500 ease-in-out"></div>
            
            <!-- Card Content -->
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="line-chart" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Vendas Totais
                </h3>
        ...
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="wallet" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Ticket Médio
                </h3>
         ...
         <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="package" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Total de Produtos
                </h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6"> <!-- Alterado para md:grid-cols-4 para adicionar o novo card -->
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="hourglass" class="w-5 h-5 mr-2 text-orange-500"></i> <!-- Ícone de ampulheta para pendente -->
                    Vendas Pendentes
                </h3>
        ...
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="shopping-cart" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Abandono Carrinho
                </h3>
        ...
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="redo" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Reembolso
                </h3>
        ...
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="badge-x" class="w-5 h-5 mr-2 text-orange-500"></i>
                    Charge Back
                </h3>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            <div id="chart-filters" class="flex items-center space-x-1 sm:space-x-2 bg-gray-100 p-1 rounded-lg">
                <button data-period="today" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md bg-orange-500 text-white shadow">Hoje</button>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="percent" class="w-5 h-5 mr-2 text-orange-500"></i>
            ...
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="qr-code" class="w-5 h-5 mr-2 text-orange-500"></i>
                        Vendas Pix
                    </h3>
            ...
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="receipt" class="w-5 h-5 mr-2 text-orange-500"></i>
                        Vendas Boleto
                    </h3>
            ...
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="credit-card" class="w-5 h-5 mr-2 text-orange-500"></i>
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(data => {
                ...
                const chartConfig = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Vendas',
                            backgroundColor: 'rgba(249, 115, 22, 0.2)', // orange-500 com opacidade
                            borderColor: '#f97316', // orange-500 sólido
                            borderWidth: 2,
                            tension: 0.4,
                            fill: true,
    ...
    filterButtonsContainer.addEventListener('click', function(e) {
        if (e.target.tagName === 'BUTTON') {
            ...
            e.target.classList.add('bg-orange-500', 'text-white', 'shadow');
