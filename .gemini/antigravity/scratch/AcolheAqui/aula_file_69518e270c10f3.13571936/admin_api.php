...
try {
    ...
    elseif ($action === 'get_email_settings') {
        ...
        $default_subject = "Acesso ao seu Produto Starfy!";
        $default_html_template = '
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <p>Seus produtos adquiridos na Starfy foram liberados com sucesso!</p>
                    ...
                    <div class="footer">
                        ...
                        <p>&copy; ' . date("Y") . ' Starfy. Todos os direitos reservados.</p>
                    </div>
                </div>
            </body>
            </html>
        ...
        $response_configs = [
            ...
            'smtp_from_name' => $configs['smtp_from_name'] ?? 'Starfy',
    ...
    elseif ($action === 'send_test_email' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            $mail->Subject = 'Email de Teste Starfy SMTP';
            $mail->isHTML(true);
