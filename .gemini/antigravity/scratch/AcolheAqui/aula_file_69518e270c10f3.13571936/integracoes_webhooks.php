...
try {
    ...
    $mensagem = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Erro ao buscar produtos para Webhooks: " . htmlspecialchars($e->getMessage()) . "</div>";
...
<div class="container mx-auto">
    <div class="flex items-center mb-6">
        <a href="index.php?pagina=integracoes" class="text-orange-600 hover:text-orange-800 mr-4">
            <i data-lucide="arrow-left-circle" class="w-8 h-8"></i>
        </a>
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Gerenciar Webhooks</h1>
            <p class="text-gray-600">Conecte a Starfy a outras plataformas.</p>
        </div>
    </div>
        ...
        <form id="webhook-form" class="space-y-6">
            ...
            <div>
                ...
                <input type="url" id="webhook_url" name="webhook_url" required
                       class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                       placeholder="Ex: https://webhook.site/abcdef-123456">
                <p class="text-xs text-gray-500 mt-1">Esta é a URL para onde os dados serão enviados.</p>
            </div>

            <div>
                <label for="produto_id" class="block text-gray-700 text-sm font-semibold mb-2">Produto Associado (Opcional)</label>
                ...
                <p class="text-xs text-gray-500 mt-1">Selecione um produto para que este webhook seja acionado apenas para vendas dele. Deixe vazio para acionar para todos os produtos.</p>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4 mt-6">
                ...
                <button type="submit" id="save-webhook-btn" class="bg-orange-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-orange-700 transition duration-300 flex items-center space-x-2">
            ...
            if (result.success) {
                ...
                if (result.webhooks.length === 0) {
                    ...
                    result.webhooks.forEach(webhook => {
                        ...
                        const produtoNome = webhook.produto_nome ? htmlspecialchars(webhook.produto_nome) : '<span class="text-gray-500">(Todos os produtos)</span>';
                        ...
                        webhookItem.innerHTML = `
                            <div class="flex-1 mb-2 sm:mb-0">
                                ...
                                <p class="text-sm text-gray-600 mt-1">Produto: ${produtoNome}</p>
