<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            <div class="absolute inset-0 rounded-lg bg-gradient-to-l from-amber-400 to-emerald-500 opacity-0 group-hover:opacity-30 pointer-events-none z-0 bg-[size:200%_100%] bg-[position:0%_0%] group-hover:bg-[position:100%_0%] transition-all duration-500 ease-in-out"></div>
            
            <!-- Card Content -->
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="line-chart" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Vendas Totais
                </h3>
                <p id="vendas-totais" class="text-3xl font-bold text-gray-800">R$ 0,00</p>
            </div>
        </div>
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="bar-chart-2" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Quantidade de Vendas
                </h3>
                <p id="quantidade-vendas" class="text-3xl font-bold text-gray-800">0</p>
            </div>
        </div>
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="wallet" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Ticket Médio
                </h3>
                <p id="ticket-medio" class="text-3xl font-bold text-gray-800">R$ 0,00</p>
            </div>
        </div>
         <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="package" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Total de Produtos
                </h3>
                <p id="total-produtos" class="text-3xl font-bold text-gray-800">0</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6"> <!-- Alterado para md:grid-cols-4 para adicionar o novo card -->
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="hourglass" class="w-5 h-5 mr-2 text-emerald-500"></i> <!-- Ícone de ampulheta para pendente -->
                    Vendas Pendentes
                </h3>
                <p id="vendas-pendentes-valor" class="text-2xl font-bold text-gray-800">R$ 0,00</p>
                <p class="text-sm text-gray-600">Total: <span id="vendas-pendentes-quantidade">0</span> vendas</p>
            </div>
        </div>
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="shopping-cart" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Abandono Carrinho
                </h3>
                <p id="abandono-carrinho" class="text-3xl font-bold text-gray-800">0</p>
            </div>
        </div>
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="redo" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Reembolso
                </h3>
                <p id="reembolsos" class="text-3xl font-bold text-gray-800">R$ 0,00</p>
            </div>
        </div>
        <div class="group relative bg-gray-50 p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
            <!-- Subtle Neon Overlay -->
            ...
            <div class="relative z-10">
                <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                    <i data-lucide="badge-x" class="w-5 h-5 mr-2 text-emerald-500"></i>
                    Charge Back
                </h3>
                <p id="chargebacks" class="text-3xl font-bold text-gray-800">R$ 0,00</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            <h3 id="chart-title" class="text-xl font-semibold text-gray-800">Vendas</h3>
            <div id="chart-filters" class="flex items-center space-x-1 sm:space-x-2 bg-gray-100 p-1 rounded-lg">
                <button data-period="today" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md bg-emerald-500 text-white shadow">Hoje</button>
                <button data-period="yesterday" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md text-gray-600 hover:bg-gray-200">Ontem</button>
                <button data-period="7days" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md text-gray-600 hover:bg-gray-200">7 dias</button>
                <button data-period="month" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md text-gray-600 hover:bg-gray-200">Mês</button>
                <button data-period="year" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md text-gray-600 hover:bg-gray-200">Ano</button>
                <button data-period="all" class="filter-btn px-3 py-1 text-sm font-semibold rounded-md text-gray-600 hover:bg-gray-200">Total</button>
            </div>
        </div>
        <div class="h-140">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Métricas de Pagamento</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                <!-- Subtle Neon Overlay -->
                <div class="absolute inset-0 rounded-lg bg-gradient-to-l from-amber-400 to-emerald-500 opacity-0 group-hover:opacity-30 pointer-events-none z-0 bg-[size:200%_100%] bg-[position:0%_0%] group-hover:bg-[position:100%_0%] transition-all duration-500 ease-in-out"></div>
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="percent" class="w-5 h-5 mr-2 text-emerald-500"></i>
                        Taxa de Conversão Geral
                    </h3>
                    <p id="taxa-conversao-geral" class="text-2xl font-bold text-gray-800">0%</p>
                </div>
            </div>
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                <!-- Subtle Neon Overlay -->
                ...
                <div class="relative z-10">
                    <h3 class="flex items-center text-gray-500 text-sm font-medium mb-2">
                        <i data-lucide="qr-code" class="w-5 h-5 mr-2 text-emerald-500"></i>
                        Vendas Pix
                    </h3>
                    <p class="text-xl font-bold text-gray-800"><span id="pix-vendas-valor">R$ 0,00</span></p>
                    <p class="text-sm text-gray-600">Conversão: <span id="pix-vendas-percentual">0%</span></p>
                </div>
            </div>
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                <!-- Subtle Neon Overlay -->
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xl font-bold text-gray-800"><span id="boleto-vendas-valor">R$ 0,00</span></p>
                    <p class="text-sm text-gray-600">Conversão: <span id="boleto-vendas-percentual">0%</span></p>
                </div>
            </div>
            <div class="group relative bg-gray-50 p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
                <!-- Subtle Neon Overlay -->
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xl font-bold text-gray-800"><span id="cartao-vendas-valor">R$ 0,00</span></p>
                    <p class="text-sm text-gray-600">Conversão: <span id="cartao-vendas-percentual">0%</span></p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const Starfy_STAGES = [
        ...
        { name: 'SUPERNOVA DOURADA', min: 500000, max: 1000000, description: 'Um evento cósmico de proporções grandiosas! Sua energia explode, iluminando vastas extensões. Você é uma força que redefine o seu entorno, uma referência inconfundível.', color: 'from-yellow-400 via-amber-600 to-emerald-700' },
        { name: 'GALÁXIA SUPREMA', min: 1000000, max: 5000000, description: 'Você se tornou um universo em si, com trilhões de estrelas e uma complexidade que inspira. Uma galáxia construída com visão, resiliência e paixão, reconhecida por sua vastidão.', color: 'from-emerald-400 via-red-600 to-rose-700' },
    ...
    function updateKpiAndChart(period = 'today') {
        ...
        fetch(`api.php?action=get_dashboard_data&period=${period}`)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                const chartConfig = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Vendas',
                            backgroundColor: 'rgba(249, 115, 22, 0.2)', // emerald-500 com opacidade
    ...
    filterButtonsContainer.addEventListener('click', function(e) {
        if (e.target.tagName === 'BUTTON') {
            ...
            e.target.classList.add('bg-emerald-500', 'text-white', 'shadow');
