...
// Este arquivo (register.php) é a página de registro para novos PROFISSIONAIS
...
<body class="bg-slate-50 min-h-screen">
    ...
    <div class="min-h-screen grid lg:grid-cols-2">
        ...
        <div class="hidden lg:flex relative flex-col justify-end p-12 overflow-hidden bg-slate-900 order-2 lg:order-1">
            <div class="absolute inset-0 z-0">
                <img src="assets/login_bg.png" class="w-full h-full object-cover opacity-90" alt="Background">
                <div class="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent"></div>
            </div>

            <div id="notifications-wrapper"
                class="absolute inset-0 pointer-events-none z-10 p-8 flex flex-col justify-center items-start gap-4">
            </div>

            <div class="relative z-20 mb-8 max-w-lg">
                <div
                    class="inline-block px-3 py-1 mb-4 rounded-full bg-emerald-500/20 border border-emerald-500/30 backdrop-blur-md">
                    <span class="text-emerald-400 text-xs font-bold tracking-wider uppercase">Junte-se à Elite</span>
                </div>
                <h1 class="text-5xl font-bold text-white mb-4 leading-tight">
                    Comece a vender <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-200">em
                        minutos.</span>
                </h1>
        ...
        <div class="flex items-center justify-center p-8 bg-white order-1 lg:order-2">
            <div class="w-full max-w-[480px] space-y-6">
                ...
                <div class="text-center">
                    <div class="inline-flex justify-center mb-6 p-4 rounded-3xl bg-emerald-50 mb-4">
                        <img src="assets/logo.png" alt="Logo" class="w-auto h-12 object-contain">
                    </div>
                    <h2 class="mt-6 text-3xl font-extrabold text-slate-900">Cadastro de Infoprodutor</h2>
                    <p class="mt-2 text-sm text-slate-600">
                        Crie sua conta para vender seus produtos/tratamentos
                    </p>
                </div>
                ...
                <?php if (!empty($cadastro_sucesso)): ?>
                    <div
                        class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl flex items-center gap-3 animate-pulse">
                        <i data-lucide="check-circle" class="w-5 h-5 flex-shrink-0"></i>
                        <p class="text-sm font-medium"><?php echo htmlspecialchars($cadastro_sucesso); ?></p>
                    </div>
                <?php endif; ?>

                <!-- Mensagens de Erro Globais (opcional, jÃ¡ que validamos inline, mas bom para garantir) -->
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="space-y-4">
                    ...
                    <div class="modern-input-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nome" id="nome"
                                ...
                                value="<?php echo htmlspecialchars($nome); ?>" required placeholder="Seu nome completo">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="modern-input-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="senha" id="senha"
                                    ...
                                    value="<?php echo htmlspecialchars($senha); ?>" required
                        ...
                        <div class="modern-input-group">
                            <label for="confirm_senha"
                                class="block text-slate-700 text-sm font-bold mb-1 ml-1">Confirmar</label>
                            <div class="relative">
                                ...
                                <input type="password" name="confirm_senha" id="confirm_senha"
                                    ...
                                    value="<?php echo htmlspecialchars($confirm_senha); ?>" required
                    ...
                    <button type="submit"
                        class="btn-primary w-full text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 group mt-6">
                        <span>Criar Conta GrÃ¡tis</span>
                ...
                <div class="pt-6 border-t border-slate-100 text-center">
                    <p class="text-slate-500 text-sm">
                        JÃ¡ tem uma conta?
                        <a href="login.php"
                            class="text-emerald-600 font-semibold hover:text-emerald-700 transition-colors">Fazer
                            Login</a>
                    </p>
                </div>
            </div>
    ...
    <script>
        ...
        // Mesma lÃ³gica de notificaÃ§Ãµes da tela de login para consistÃªncia
        const wrapper = document.getElementById('notifications-wrapper');
        const names = ['Gabriel S.', 'Amanda M.', 'Lucas R.', 'Beatriz C.', 'JoÃ£o P.', 'Fernanda L.'];
        const actions = [
            { type: 'Nova Conta', icon: 'user-plus', color: 'text-emerald-500', valueRange: [0, 0] }, // Exclusivo para pÃ¡gina de registro
        ...
        function createNotification() {
            ...
            notif.className = 'notification-card glass-effect rounded-2xl p-4 flex items-center gap-4 w-72 transform transition-all shadow-xl border-l-4 border-emerald-500';
