            ...
            <form id="relatorios-form">
                <div class="mb-6 border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select id="tipo_relatorio" name="tipo_relatorio" class="form-input-style">
                                ...
                                <option value="servi�os_vendidos">Servi�os Vendidos</option>
                    ...
                    <div class="mt-6 text-right">
                        <button type="submit" class="bg-emerald-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-emerald-700 transition duration-300 flex items-center justify-center space-x-2 ml-auto">
